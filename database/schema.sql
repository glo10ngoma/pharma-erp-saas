...
CREATE INDEX idx_fefo_actions_tenant_site ON fefo_actions(tenant_id, site_id, performed_at DESC);
CREATE INDEX idx_fefo_actions_lot ON fefo_actions(lot_id, performed_at DESC);
CREATE UNIQUE INDEX uq_fefo_actions_request_key ON fefo_actions(tenant_id, request_key) WHERE request_key IS NOT NULL;
