...
const BUSINESS_ERRORS: Record<string, number> = {
  ...
  SALE_NOT_ADVANCE: HttpStatus.CONFLICT,
  SALE_NOT_VALIDATED: HttpStatus.CONFLICT,
  SALE_ALREADY_FULFILLED: HttpStatus.CONFLICT,
  SALE_PICKUP_QUANTITY_INVALID: HttpStatus.BAD_REQUEST,
  SALE_PICKUP_ITEM_NOT_FOUND: HttpStatus.NOT_FOUND,
  SALE_PICKUP_STOCK_INSUFFICIENT: HttpStatus.CONFLICT,
  SALE_PICKUP_NOT_ALLOWED: HttpStatus.FORBIDDEN,
  ...
  TRANSFER_EMPTY: HttpStatus.BAD_REQUEST,
  TRANSFER_SAME_SITE: HttpStatus.BAD_REQUEST,
  INVALID_TRANSFER_QUANTITY: HttpStatus.BAD_REQUEST,
  LOT_NOT_IN_TENANT: HttpStatus.BAD_REQUEST,
