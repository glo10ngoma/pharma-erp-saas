          ...
          <div className="card">
            ...
            {query.isError ? (
              ...
              <FloatingSearchPopover
                ...
                onOpen={() => void 0}
                onClose={() => void 0}
                onSelect={(sale) => create.mutate({ saleId: sale.saleId, saleLinkStatus: 'LINKED' })}
                open
            ...
            <div className="card">
              <div className="panel-heading">
                <div>
                  ...
                  <p className="muted">Recherchez d abord une vente probable, puis saisissez les informations obligatoires du retour exceptionnel.</p>
                </div>
              </div>
                  ...
                  <tbody>
                    {probableSales.length === 0 ? (
                      ...
                      <tr key={sale.saleId}>
                        ...
                        <td>
                          <button className="ghost-button compact-button" type="button" onClick={() => create.mutate({ saleId: sale.saleId, probableSaleId: sale.saleId, saleLinkStatus: 'PROBABLE' })}>
                            Utiliser
                          </button>
                        </td>
                      </tr>
